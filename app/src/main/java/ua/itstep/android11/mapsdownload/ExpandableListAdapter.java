...
/**
 * Created by Maksim Baydala on 10/05/17.
 * clone of SimpleExpandableListAdapter.
 */
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private void bindView(View view, Map<String, ?> data, String[] from, int[] to) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (icon != null) {
                icon.getDrawable().mutate().setColorFilter(view.getResources().getColor(R.color.colorItemIcon), PorterDuff.Mode.SRC_IN);
            }
        }
    }
